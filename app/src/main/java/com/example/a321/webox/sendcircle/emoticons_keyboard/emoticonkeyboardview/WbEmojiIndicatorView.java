...
public class WbEmojiIndicatorView extends LinearLayout {
    ...
    public WbEmojiIndicatorView(Context context) {
        this(context,null);
    }

    public WbEmojiIndicatorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WbEmojiIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
