...
import com.example.a321.webox.sendcircle.emoticons_keyboard.adapter.EmotionGridViewAdapter;
import com.example.a321.webox.sendcircle.emoticons_keyboard.adapter.EmotionPagerAdapter;
import com.example.a321.webox.sendcircle.emoticons_keyboard.emoticonkeyboardview.WbEmojiIndicatorView;
import com.example.a321.webox.sendcircle.emoticons_keyboard.util.DisplayUtils;
...
public class EmotiomComplateFragment extends BaseFragment{
    ...
    private WbEmojiIndicatorView ll_point_group;//表情面板对应的点列表
    ...
    protected void initView(View rootView){
        ...
        ll_point_group= (WbEmojiIndicatorView) rootView.findViewById(R.id.ll_point_group);
        //获取map的类型
    ...
    private void initEmotion() {
        ...
        // 遍历所有的表情的key
        for (String emojiName : EmoUtils.getEmojiMap(emotion_map_type).keySet()) {
