...
import com.example.a321.webox.sendcircle.emoticons_keyboard.adapter.HorizontalRecyclerviewAdapter;
import com.example.a321.webox.sendcircle.emoticons_keyboard.adapter.NoHorizontalScrollerVPAdapter;
import com.example.a321.webox.sendcircle.emoticons_keyboard.emoticonkeyboardview.EmotionKeyboard;
import com.example.a321.webox.sendcircle.emoticons_keyboard.emoticonkeyboardview.WbNoHorizontalScrollerViewPager;
import com.example.a321.webox.sendcircle.emoticons_keyboard.model.ImageModel;
import com.example.a321.webox.sendcircle.emoticons_keyboard.util.EmoUtils;
import com.example.a321.webox.sendcircle.emoticons_keyboard.util.GlobalOnItemClickManagerUtils;
import com.example.a321.webox.sendcircle.emoticons_keyboard.util.SharedPreferencedUtils;
...
public class EmotionMainFragment extends BaseFragment{
    ...
    //不可横向滚动的ViewPager
    private WbNoHorizontalScrollerViewPager viewPager;
    ...
    protected void initView(View rootView){
        viewPager= (WbNoHorizontalScrollerViewPager) rootView.findViewById(R.id.vp_emotionview_layout);
    ...
    private void replaceFragment(){
        ...
        //创建修改实例
        EmotiomComplateFragment f1= (EmotiomComplateFragment) factory.getFragment(EmoUtils.EMOTION_CLASSIC_TYPE);
        fragments.add(f1);
        Bundle b=null;
        for (int i=0;i<7;i++){
            b=new Bundle();
